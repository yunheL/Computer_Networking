...
10.100.0.0 255.255.0.0 172.16.42.2 router-eth2''')
    ...
    arpreq3 = create_ip_arp_request("10:00:00:00:00:03", "172.16.42.1", "192.168.1.1") 
    arpresp3 = mk_arpresp(arpreq3, "10:00:00:00:00:01") # , "10:00:00:00:00:03", "172.16.42.2", "172.16.42.1")

    arpreq4 = create_ip_arp_request("10:00:00:00:00:03", "172.16.42.1", "172.16.42.2")
...
####### ARP received with no match in IP-queue table should not crash #####
    s.expect(PacketInputEvent("router-eth0", arpresp5, display=Arp),
             "Router receive ARP with IP_dst not in IP_queue should not crashed")
#########################################################################    
